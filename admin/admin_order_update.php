...
<head>
    <?php
        ...
        if(isset($_POST["upd_confirm"])){
            ...
            $status = $_POST["os"];
            $st = "";
            if($status == 'FNSH'){ $st = ", orh_finishedtime='".date('Y-m-d\TH:i:s')."'";}
            $query = "UPDATE order_header SET orh_orderstatus = '{$status}' ".$st." WHERE orh_id = {$orh_id};";
...
<body class="d-flex flex-column h-100">
    ...
    <footer
        ...
        <span class="smaller-font">&copy; 2022 Pizza World<br /><span class="xsmall-font">All Rights Reserved.</span></span>
        <ul class="nav justify-content-end list-unstyled d-flex">
            <li class="ms-3"><a class="text-light" target="_blank" href="https://github.com"><i
