...
<body class="d-flex flex-column h-100">
    ...
    <!-- <?php
            if(isset($_GET["search"])){
                ...
                $query = "SELECT orh.orh_id,orh.orh_refcode,orh.orh_ordertime,c.c_firstname,c.c_lastname,orh.orh_orderstatus,p.p_amount,p.p_detail, s.s_name
                FROM order_header orh INNER JOIN customer c ON orh.c_id = c.c_id INNER JOIN payment p ON p.p_id = orh.p_id
                INNER JOIN shop s ON orh.s_id = s.s_id WHERE c.c_type LIKE '%{$_GET['s']}%'
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="admin_order_update.php?orh_id=<?php echo $row["orh_id"]?>" class="btn btn-sm btn-outline-success">Update</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
        ...
        <span class="smaller-font">&copy; 2022 Pizzas Roca Jed<br /><span class="xsmall-font">Todos los derechos reservados.</span></span>
