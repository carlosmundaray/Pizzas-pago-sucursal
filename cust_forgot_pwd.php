...
<header class="navbar navbar-expand-md navbar-light fixed-top shadow-sm mb-auto" style="background-color: #ff8c00;">
    ...
    <div class="container form-signin mt-auto">
        ...
        <form method="POST" action="cust_reset_pwd.php" class="form-floating">
            <h2 class="mt-4 mb-3 fw-normal text-bold"><i class="bi bi-key me-2"></i>Olvidaste tu contraseña?</h2>
            <p class="mt-4 mb-3 fw-normal">Ingrese su información a continuación.</p>
            ...
            <button class="w-100 btn btn-success mb-3" type="submit">Siguiente</button>
        </form>
    </div>
