...
<head>
    ...
    <title>Acceso Restringido | Pizzas Roca Jed</title>
</head>
...
<div class="container-fluid mx-4">
            <a href="index.php">
                <img src="img/roca-jed.png" width="65" class="me-2" alt="Sai Logo">
            </a>
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <h3 class="mt-2 mb-3 fw-normal text-bold">Acceso Restringido</h3>
            <p class="mb-3 fw-normal text-bold text-wrap">No tienes permiso para acceder a esta página.</p>
            <a class="btn btn-danger btn-sm w-50" href="index.php">Regresar a inicio</a>
    </div>
