...
<head>
    ...
    <title> Perfil | Pizzas Roca Jed</title>
</head>
    ...
    <div class="container px-5 py-4" id="cart-body">
                ...
                if($_GET["up_pwd"]==1){
                    ...
                    <div class="row row-cols-1 notibar">
                        <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                            ...
                            <span class="ms-2 mt-2">Su contraseña se actualizó correctamente!</span>
            ...
            <?php }else{ ?>
                    ...
                    <div class="row row-cols-1 notibar">
                        <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                            ...
                            </svg><span class="ms-2 mt-2">No se pudo actualizar su contraseña.</span>
                            <span class="me-2 float-end"><a class="text-decoration-none link-light" href="cust_profile.php">X</a></span>
                        </div>
                    </div>
                ...
                if($_GET["up_prf"]==1){
                    ...
                    <div class="row row-cols-1 notibar">
                        <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                            ...
                            <span class="ms-2 mt-2">¡Su perfil ha sido actualizado con éxito!</span>
                            <span class="me-2 float-end"><a class="text-decoration-none link-light" href="cust_profile.php">X</a></span>
                        </div>
                    </div>
                    ...
                    <div class="row row-cols-1 notibar">
                        <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <path
                                    d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                            </svg><span class="ms-2 mt-2">No se pudo actualizar su perfil.</span>
                            <span class="me-2 float-end"><a class="text-decoration-none link-light" href="cust_profile.php">X</a></span>
                        </div>
                    </div>
                    <!-- END FAILED UPDATED PASSWORD -->
        ...
        <div class="row row-cols-1 mt-4">
            <dl class="row">
                ...
                if($row["c_gender"]=="M"){echo "Masculino";}
                else if($row["c_gender"]=="F"){echo "Femenino";}
                else if($row["c_gender"]=="N"){echo "No binario";}?>
                </dd>

                <dt class="col-sm-3">Rol</dt>
                <dd class="col-sm-9"><?php
                if($row["c_type"]=="STD"){echo "Estudiante";}
                else if($row["c_type"]=="INS"){echo "Profesor";}
                else if($row["c_type"]=="TAS"){echo " Cliente";}
                else if($row["c_type"]=="STF"){echo " Personal";}
                else if($row["c_type"]=="GUE"){echo "Visitante";}
                else{echo "Otros";}
                ?>
                </dd>
