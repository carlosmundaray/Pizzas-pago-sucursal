...
<head>
    ...
    <title>Detalles de pedido| Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        <div class="row my-4 border-bottom">
            ...
            <h2 class="pt-3 display-6">Detalles de Pedido</h2>
            ...
            <div class="row row-cols-1 row-cols-md-2">
                    ...
                    <ul class="list-unstyled fw-light">
                        <li class="list-item mb-2">
                            <?php if($orh_arr["orh_orderstatus"]=="ACPT"){ ?>
                                <h5><span class="fw-bold badge bg-info text-dark">Aceptado</span></h5>
                            ...
                            <?php }else if($orh_arr["orh_orderstatus"]=="RDPK"){ ?>
                                <h5><span class="fw-bold badge bg-primary text-white">Listo para recoger</span></h5>
                            <?php }else if($orh_arr["orh_orderstatus"]=="FNSH"){?>
                                <h5><span class="fw-bold badge bg-success text-white">Completado</span></h5>
                            <?php } ?>
                        </li>
                        <li class="list-item">Orden #<?php echo $orh_arr["orh_refcode"];?></li>
                        <li class="list-item">de
                            <?php
                ...
                <div class="col">
                    <ul class="list-unstyled fw-light">
                        ...
                        <li>Se recogerá el <?php echo $od_pickupdate;?></li>
                        <?php }else{
                            $od_finishtime = (new Datetime($orh_arr["orh_finishedtime"])) -> format("F j, Y H:i");
                        ?>
                        <li>Finalizado el <?php echo $od_finishtime;?></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
                ...
                <div class="row row-cols-1">
                                ...
                                <li class="list-group-item d-flex border-0 pb-3 border-bottom w-100 justify-content-between align-items-center">
                                    ...
                                    <div class="ms-3 me-auto">
                                        <div class="fw-normal"><span class="h5"><?php echo $ord_row["ord_amount"]?>x </span><?php echo $ord_row["f_name"]?>
                                            <p><?php printf("  $.%.2f <small class='text-muted'>($. %.2f  each)</small>",$ord_row["ord_buyprice"]*$ord_row["ord_amount"],$ord_row["ord_buyprice"]);?><br />
                    ...
                    <div class="col my-3">
                        <ul class="list-inline justify-content-between">
                            ...
                            <li class="list-item fw-light small">
                                <?php
