...
<head>
    ...
    <title>Actualizar perfil de sucursal| Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="shop_profile_edit.php" class="form-floating" enctype="multipart/form-data">
            <h2 class="mt-4 mb-3 fw-normal text-bold"><i class="bi bi-pencil-square me-2"></i>Actualizar informacion de sucursal</h2>
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" id="shopstatus"
                name="s_status" <?php if($row["s_status"]){echo "checked";} ?>>
                <label class="form-check-label" for="shopstatus">Apertura para hoy</label>
            </div>
            <div class="form-check form-switch mb-2">
                ...
                <label class="form-check-label" for="shoppreorderstatus">Aceptando pedidos pre-orden</label>
            </div>
            ...
            <div class="form-floating mb-2">
                ...
                <label for="shoplocation">Ubicación de sucursal</label>
            </div>
            <div class="form-floating mb-2">
                ...
                <label for="shopphoneno">Numero de telefono</label>
            </div>
            <div class="row row-cols-2 g-2 mb-2">
                <div class="col">
                    <div class="form-floating">
                        ...
                        <label for="shopopenhour">Hora de apertura</label>
                    </div>
                </div>
                <div class="col">
                    <div class="form-floating">
                        ...
                        <label for="shopopenhour">Hora de cierre</label>
                    </div>
                </div>
            </div>
            <div class="mb-2">
                <label for="formFile" class="form-label">Subir imagen de la sucursal</label>
                <input class="form-control" type="file" id="s_pic" name="s_pic" accept="image/*">
            </div>
            <button class="w-100 btn btn-success mb-3" name="upd_confirm" type="submit">Actualizar perfil de sucursal</button>
        </form>
    </div>
