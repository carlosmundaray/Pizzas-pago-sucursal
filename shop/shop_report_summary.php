...
<head>
    ...
    <title>Informe de ingresos de la sucursal | Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="shop-body">
        <div class="mt-4">
            ...
            <h2 class="display-6">Informe de ingresos</h2>
            <h4 class="fw-light">
                <?php
            ...
            <p class="fw-light">Generado en: <?php echo date("F j, Y H:i")?>. Este informe sólo incluye pedidos finalizados.</p>

            <h4 class="border-top fw-light pt-3 pb-2 mt-2">Rendimiento global</h4>
                ...
                <div class="col">
                    <div class="card border-secondary">
                        <div class="card-body">
                            ...
                            <p class="card-text small">Los ingresos totales</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php
                                    ...
                                    printf("%d pedidos",$num_order);
                                ?>
                            </h5>
                            <p class="card-text small">Numero de pedidos</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php
                                    ...
                                    WHERE orh.s_id = {$s_id} AND orh_orderstatus = 'FNSH' AND (DATE(orh_finishedtime) BETWEEN DATE('{$start_date}') AND DATE('{$end_date}'));";
                                    $result = $mysqli -> query($query) -> fetch_array();
                                    if(is_null($result["cnt"])){echo "0 Customers";} else{echo $result["cnt"]." Clientes";}
                                ?>
                            </h5>
                            <p class="card-text small">Numero de clientes</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card border-secondary">
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php
                                    if($num_order == 0){echo "0.00 $.";}
                                    else{printf("%.2f $.",$grandtotal/$num_order);}
                                ?>
                            </h5>
                            <p class="card-text small">Coste medio por pedido</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php
                                    ...
                                    WHERE orh.s_id = {$s_id} AND orh_orderstatus = 'FNSH' AND (DATE(orh_finishedtime) BETWEEN DATE('{$start_date}') AND DATE('{$end_date}'));";
                                    $result = $mysqli -> query($query) -> fetch_array();
                                    if(is_null($result["amt"])){echo "0 plates";} else{echo $result["amt"]." productos";}
                                ?>
                            </h5>
                            <p class="card-text small">Número de productos vendidos</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card border-secondary">
                        <div class="card-body">
                            ...
                            <p class="card-text small">Menú de los más vendidos</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card border-secondary">
                        <div class="card-body">
                            ...
                            <p class="card-text small">Hora pico de pedidos</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card border-secondary">
                        <div class="card-body">
                            ...
                            <p class="card-text small">Hora pico de recogida</p>
                        </div>
                    </div>
                </div>
            </div>

            <h4 class="border-top fw-light pt-3 mt-2">Menú de Rendimiento</h4>
            <?php
                ...
                <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["amount"]." productos"?></td>
                            <td><?php echo $row["subtotal"]." $."?></td>
                        </tr>
                        <?php } ?>
                        <tr class="fw-bold table-info">
                            <td colspan="4" class="text-end">Gran Total</td>
                            <td><?php printf("%.2f $.",$grandtotal);?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <?php }else{ ?>
                <p class="fw-light">No hay registros</p>
            <?php } ?>
        </div>
