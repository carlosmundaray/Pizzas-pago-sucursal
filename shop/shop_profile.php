...
<head>
    ...
    <title>Perfil de Sucursal | Pizzas Roca Jed</title>
</head>
    ...
    <div class="container px-5 pt-4" id="profile-body">
        <div class="row my-4 pb-2 border-bottom">
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">¡Contraseña actualizada exitosamente!</span>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    ...
                    </svg><span class="ms-2 mt-2">No se pudo actualizar la contraseña.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light"
                            href="shop_profile.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">¡Perfil de Sucursal actualizado exitosamente!</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light"
                            href="shop_profile.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <path
                            d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                    </svg><span class="ms-2 mt-2">No se pudo actualizar el perfil de la Sucursal.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light"
                            href="shop_profile.php">X</a></span>
                </div>
            </div>
       ...
       Cambiar contraseña
        ...
        <a class="btn btn-sm btn-primary mt-2 mt-md-0" href="shop_profile_edit.php">
            ...
            Actualizar el perfil de la sucursal
        </a>
        ...
        <div class="row row-cols-1 mt-4">
            ...
            <dl class="row">
                ...
                <dt class="col-sm-3">Nombre de sucursal</dt>
                <dd class="col-sm-9"><?php echo $row["s_name"];?></dd>
                <dt class="col-sm-3">Ubicacion de susursal</dt>
                <dd class="col-sm-9"><?php echo $row["s_location"];?></dd>
                <dt class="col-sm-3">Horario de apertura de la sucursal</dt>
                <dd class="col-sm-9">
                    <?php
                    $current_time = date('H:i:s');
                    if($current_time >= $row["s_openhour"] && $current_time <= $row["s_closehour"]){
                        ?><span class="badge fs-6 bg-success">Apertura de la Sucursal</span> <?php
                    }else{
                        ?><span class="badge fs-6 bg-danger">Tienda cerrada</span> <?php
                    }
                ...
                <dt class="col-sm-3">Estado de funcionamiento de la Sucursal</dt>
                <dd class="col-sm-9">
                    <?php if($row["s_status"]==1){?>
                    <span class="badge fs-6 bg-success">Disponible para en Sucursal</span>
                    <?php }else{ ?>
                    <span class="badge fs-6 bg-danger">No disponible para en Sucursal</span>
                    <?php }
                        if($row["s_preorderstatus"]==1){?>
                    <span class="badge fs-6 bg-success">Disponible para pre-orden</span>
                    <?php }else{ ?>
                    <span class="badge fs-6 bg-danger">No disponible para pre-orden</span>
                    <?php } ?>
                </dd>
                <dt class="col-sm-3">E-mail</dt>
                <dd class="col-sm-9"><?php echo $row["s_email"];?></dd>
                <dt class="col-sm-3">Numero de telefono</dt>
                <dd class="col-sm-9"><?php echo "(01) ".$row["s_phoneno"];?></dd>
            </dl>
        </div>
