...
<head>
    ...
    <title>Inicio del Propietario de la Sucursal | Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-3">
            ...
            <h1 class="display-5 fw-normal">Bienvenidos a Pizzas Roca Jed</h1>
            <p class="lead fw-normal">Sistema de pedidos en línea de Pizzas Roca Jed
    ...
    <div class="container p-5" id="shop-dashboard">
        <h2 class="border-bottom pb-2"><i class="bi bi-graph-up"></i> Panel de control de la Sucursal <span
                    ...
                    <div class="card rounded-5 border p-2">
                        <div class="card-body">
                            ...
                            <p class="card-text my-2">
                                ...
                                pedidos que quedan por terminar
                            </p>
                            <div class="text-end">
                                <a href="shop_order_list.php" class="btn btn-sm btn-outline-dark">Ir a la Lista de los pedidos</a>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="card rounded-5 border p-2">
                        <div class="card-body">
                            ...
                            <p class="card-text my-2">
                                ...
                                Menús disponibles para ordenar
                            </p>
                            <div class="text-end">
                                <a href="shop_menu_list.php" class="btn btn-sm btn-outline-dark">Ir a la lista de menú</a>
                            </div>
                        </div>
                    </div>
                </a>
