...
<head>
    ...
    <title>Informe de ingresos | Pizzas Roca Jed</title>
</head>
    ...
    <div class="container form-signin">
        ...
        <form method="GET" action="shop_report_summary.php" class="form-floating">
            <h2 class="mt-4 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                ...
                </svg> Informe de ingresos</h2>
            <p>Seleccione la opción a continuación para ver su informe de ventas e ingresos.</p>
            ...
            <div class="form-check">
                ...
                Ayer<br />(<?php echo (new Datetime()) -> sub(new DateInterval("P1D")) -> format('F j, Y');?>)
                </label>
            </div>
            <div class="form-check">
            ...
            <button class="w-100 btn btn-outline-success my-3" type="submit">Generar Reporte</button>
        </form>
    </div>
