...
<head>
    ...
    <title>Detalle del pedido | Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 pt-4" id="cart-body">
        <div class="row my-4 border-bottom">
            ...
            <h2 class="pt-3 display-5">Pedido #<?php echo $orh_arr["orh_refcode"];?></h2>
                ...
                <div class="col mb-2 mb-md-0">
                    <ul class="list-unstyled fw-light">
                        <li class="list-item mb-2">
                            ...
                            <h5>Current Status: <span class="fw-bold badge bg-info text-dark">Aceptado</span></h5>
                            <?php }else if($orh_arr["orh_orderstatus"]=="PREP"){ ?>
                            <h5>Current Status: <span class="fw-bold badge bg-warning text-dark">Preparando</span></h5>
                            <?php }else if($orh_arr["orh_orderstatus"]=="RDPK"){ ?>
                            <h5>Current Status: <span class="fw-bold badge bg-primary text-white">Listo para recoger</span></h5>
                            <?php }else if($orh_arr["orh_orderstatus"]=="FNSH"){?>
                            <h5>Current Status: <span class="fw-bold badge bg-success text-white">Completado</span></h5>
                            <?php } ?>
                        </li>
                        <li class="list-item">Pedido de
                            <?php
            ...
            <div class="row mb-3">
                <div class="col">
                <?php if($orh_arr["orh_orderstatus"]!='FNSH'){ ?>
                <a class="btn btn-sm btn-warning mt-2 mt-md-0" href="shop_order_forward.php?orh_id=<?php echo $_GET["orh_id"]?>&cur_stage=1">Marcar como en preparación</a>
                <a class="btn btn-sm btn-primary mt-2 mt-md-0" href="shop_order_forward.php?orh_id=<?php echo $_GET["orh_id"]?>&cur_stage=2">Marcar como listo para recoger</a>
                <a class="btn btn-sm btn-success mt-2 mt-md-0" href="shop_order_forward.php?orh_id=<?php echo $_GET["orh_id"]?>&cur_stage=3">Marcar como terminada</a>
                <?php }?>
                </div>
            </div>
        </div>
                ...
                <div class="row row-cols-1">
                            ...
                            <ul class="list-group">
                                    <li
                                        ...
                                        <div class="image-parent">
                                            <img <?php
                                            if(is_null($ord_row["f_pic"])){echo "src='../img/roca-jed.png'";}
                                        ...
                                        <div class="ms-3 me-auto">
                                            <div class="fw-normal"><span class="h5"><?php echo $ord_row["ord_amount"]?>x
                                                ...
                                                <p><?php printf("%.2f $. <small class='text-muted'>(%.2f $. cada uno)</small>",$ord_row["ord_buyprice"]*$ord_row["ord_amount"],$ord_row["ord_buyprice"]);?><br />
                                                    <span
                    ...
                    <div class="col my-3">
                        <ul class="list-inline justify-content-between">
                            ...
                            <li class="list-item fw-light small">Pagado por
                                <?php
