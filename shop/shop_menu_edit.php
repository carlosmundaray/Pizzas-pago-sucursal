...
<head>
    ...
    <title>Actualizar detalle del menú| Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="shop_menu_edit.php" class="form-floating" enctype="multipart/form-data">
            <h2 class="mt-4 mb-3 fw-normal text-bold"><i class="bi bi-pencil-square me-2"></i>Actualizar detalles del menú</h2>
            ...
            <div class="form-floating mb-2">
                <input type="number" step=".25" min="0.00" max="999.75" class="form-control" id="f_price" placeholder="Price ($.)" value="<?php echo $row["f_price"];?>" name="f_price" required>
            ...
            <button class="w-100 btn btn-success mb-3" name="upd_confirm" type="submit">Actualizar detalles del menú</button>
        </form>
    </div>
