...
<head>
    ...
    <title>Lista de pedidos de clientes| Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 pt-4" id="shop-body">
        ...
        <?php
            ...
            <div class="row row-cols-1 notibar">
                <div class="col ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">Estado del pedido actualizado exitosamente.</span>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col ms-2 p-2 bg-danger text-white rounded text-start">
                    ...
                    </svg><span class="ms-2 mt-2">No se pudo actualizar el estado del pedido.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="shop_order_list.php">X</a></span>
                </div>
            </div>
        ...
        <div class="my-3 text-wrap" id="shop-header">
            <h2 class="display-6 fw-light">Pedido del cliente</h2>
        </div>
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active px-4" id="acpt-tab" data-bs-toggle="tab" data-bs-target="#nav-acpt"
                    ...
                    aria-selected="true">ACPT | Aceptada</button>
                <button class="nav-link px-4" id="prep-tab" data-bs-toggle="tab" data-bs-target="#nav-prep"
                    ...
                    aria-selected="true">PREP | Preparando</button>
                <button class="nav-link px-4" id="rdpk-tab" data-bs-toggle="tab" data-bs-target="#nav-rdpk"
                    ...
                    aria-selected="true">RDPK | Esperar la recogida</button>
                <button class="nav-link px-4" id="fnsh-tab" data-bs-toggle="tab" data-bs-target="#nav-fnsh"
                    type="button" role="tab" aria-controls="nav-fnsh" aria-selected="false">FNSH | Finalizado</button>
            </div>
        </nav>
            ...
            <div class="tab-pane fade show active p-3" id="nav-acpt" role="tabpanel" aria-labelledby="acpt-tab">
                        ...
                        <a href="shop_order_detail.php?orh_id=<?php echo $og_row["orh_id"]?>"
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-info text-dark justify-content-between">
                                    <small class="me-auto d-flex" style="font-weight: 500;">Pedido aceptado</small>
                                </div>
                                <div class="card-body">
                                    <div class="card-text row row-cols-1">
                                        <small>
                                        <div class="col">Pedido #<?php echo $og_row["orh_refcode"];?></div>
                                        <div class="col">Nombre:
                                            ...
                                            switch($cust_arr["c_type"]){
                                                case "STD": $cust_type = "Estudiante"; break;
                                                case "INS": $cust_type = "Profesor"; break;
                                                case "TAS": $cust_type = "Cliente"; break;
                                                case "STF": $cust_type = "Personal"; break;
                                                case "GUE": $cust_type = "Visitante"; break;
                                                default: $cust_type = "Otros";
                                            }
                                            echo "{$cust_arr['c_firstname']} {$cust_arr['c_lastname']} ({$cust_type})";
                                        ?>
                                        </div>
                                        <div class="col mb-2">Hora de recogida:
                                            <?php
                                    ...
                                    ?>
                                        <div class="col pt-2 mb-2 border-top"><?php echo $ord_arr["cnt"]?> menus | <?php echo $ord_arr["gt"]?> $.</div>
                                        </small>
                                        <div class="col">
                                        ...
                                        <div class="col text-end">
                                            <a href="shop_order_detail.php?orh_id=<?php echo $og_row["orh_id"]?>" class="btn btn-sm btn-outline-secondary">Más detalles</a>
                                            <a href="shop_order_forward.php?orh_id=<?php echo $og_row["orh_id"]?>&cur_stage=1" class="btn btn-sm btn-success">Marcar como en preparación</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row row-cols-1">
                    <div class="col pt-3 px-3 bg-danger text-white rounded text-center">
                        ...
                        <p class="ms-2 mt-2">No se encontró ningún pedido.</p>
                    </div>
                </div>
                <!-- END CASE NO ORDER -->
                <?php } ?>
                        ...
                        <a href="shop_order_detail.php?orh_id=<?php echo $og_row["orh_id"]?>"
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-warning justify-content-between">
                                    <small class="me-auto d-flex" style="font-weight: 500;">Preparando pedido</small>
                                </div>
                                <div class="card-body">
                                    <div class="card-text row row-cols-1">
                                        <small>
                                    ...
                                    ?>
                                        ...
                                        <div class="col text-end">
                                            <a href="shop_order_detail.php?orh_id=<?php echo $og_row["orh_id"]?>" class="btn btn-sm btn-outline-secondary">Más detalles</a>
                                            <a href="shop_order_forward.php?orh_id=<?php echo $og_row["orh_id"]?>&cur_stage=2" class="btn btn-sm btn-success">Marcar como listo</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="shop_order_detail.php?orh_id=<?php echo $og_row["orh_id"]?>"
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-primary text-white justify-content-between">
                                    <small class="me-auto d-flex" style="font-weight: 500;">Listo para recoger</small>
                                </div>
                                <div class="card-body">
                                    <div class="card-text row row-cols-1">
                                        <small>
                                        ...
                                        <div class="col">Nombre:
                                            ...
                                            $cust_arr = $mysqli -> query($cust_query) -> fetch_array();
                                            switch($cust_arr["c_type"]){
                                                case "STD": $cust_type = "Menores de 15 años"; break;
                                                case "INS": $cust_type = "16 Años - 20 Años"; break;
                                                case "TAS": $cust_type = "21 Años - 30 Años"; break;
                                                case "STF": $cust_type = "31 Años - 40 Años"; break;
                                                case "GUE": $cust_type = "41 Años - 50 Años"; break;
                                                default: $cust_type = "Arriba de 51 Años";
                                            }
                                            echo "{$cust_arr['c_firstname']} {$cust_arr['c_lastname']} ({$cust_type})";
                                        ?>
                                        </div>
                                    ...
                                    ?>
                                        ...
                                        <div class="col text-end">
                                            <a href="shop_order_detail.php?orh_id=<?php echo $og_row["orh_id"]?>" class="btn btn-sm btn-outline-secondary">Más detalles</a>
                                            <a href="shop_order_forward.php?orh_id=<?php echo $og_row["orh_id"]?>&cur_stage=3" class="btn btn-sm btn-success">Marcar como finalizado</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="shop_order_detail.php?orh_id=<?php echo $og_row["orh_id"]?>"
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-success text-white justify-content-between">
                                    <small class="me-auto d-flex" style="font-weight: 500;">Pedido finalizado</small>
                                </div>
                                <div class="card-body">
                                    <div class="card-text row row-cols-1">
                                        <small>
                                        ...
                                        <div class="col mb-2">Finalizado el
                                            <?php
