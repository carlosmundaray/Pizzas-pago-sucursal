...
<head>
    ...
    <title>Actualizar contraseña de sucursal | Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="shop_update_pwd.php" class="form-floating">
            <h2 class="mt-4 mb-3 fw-normal text-bold"><i class="bi bi-key me-2"></i>Actualizar contraseña de la sucursal</h2>
            ...
            <div class="form-floating mb-2">
                <input type="password" class="form-control" id="rst_pwd" minlength="8" maxlength="45" placeholder="New Password" name="new_pwd"
                    required>
                <label for="rst_pwd">Nueva contraseña</label>
            </div>
            <div class="form-floating mb-2">
                ...
                <label for="rst_cfpwd">Confirmar nueva contraseña </label>
                <div id="passwordHelpBlock" class="form-text smaller-font">
                La nueva contraseña debe tener al menos 8 caracteres.
                </div>
            </div>
            <button class="w-100 btn btn-success my-3" name="rst_confirm" type="submit" onclick="return confirm('Do you want to update the shop password?');" >Actualizar contraseña de sucursal</button>
        </form>
    </div>
