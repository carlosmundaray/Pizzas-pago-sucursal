...
<head>
    ...
    <title>Lista de surcursal | Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container p-5" id="recommended-shop">
        ...
        <h3 class="border-bottom pb-2"><i class="bi bi-shop align-top"></i> Sucursal Disponible</h3>
                ...
                <a href="<?php echo "shop_menu.php?s_id=".$row["s_id"]?>" class="text-decoration-none text-dark">
                    <div class="card rounded-25">
                        ...
                        <div class="card-body">
                            ...
                            ?>
                            <p class="card-text my-2">Horas de apertura: <?php echo $open[0].":".$open[1]." - ".$close[0].":".$close[1]?></p>
                            <div class="text-end">
                                <a href="<?php echo "shop_menu.php?s_id=".$row["s_id"]?>" class="btn btn-sm btn-primary">Ir a la sucursal</a>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <?php }
            ...
            <div class="row row-cols-1">
                    <div class="col pt-3 px-3 bg-danger text-white rounded text-center">
                        ...
                        <p class="ms-2 mt-2">No hay ninguna sucursal disponible actualmente para realizar pedidos!</p>
                    </div>
            </div>
            <?php
        }
