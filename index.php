...
<body class="d-flex flex-column h-100">
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Bienvenido a Pizzas Roca Jed</h1>
            <p class="lead fw-normal">Sistema de pedidos en línea de Pizzas Roca Jed</p>
        </div>
    </div>
    ...
    <section class="section" id="trainers">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        <h2>Nuestro <em>Menu</em></h2>
                        <br>
                        <p>Además de solo pizzas, contamos con un extenso menú de alimentos deliciosos preparados con la máxima calidad y cariño.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="trainer-item">
                        ...
                        <div class="down-content">
                            ...
                            <p>pizza que contiene una base de queso fundido y tomate que se aliñan con jamón y piña.</p>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="img/pizza-mexicana.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>
                            $. 225
                            ...
                            <p>Pizza elaborada con los ingredientes habituales de la cocina mexicana.</p>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        ...
                        <div class="down-content">
                            ...
                            <p>La pizza pepperoni es una variante clásica de pizza italiana que combina sabores intensos y texturas irresistibles.</p>
            ...
            <center>
  <a class="btn btn-primary me-1" href="shop_menu.php?s_id=2"
    ...
    <div class="container p-5" id="recommended-shop">
        <h2 class="border-bottom pb-2"><i class="bi bi-shop align-top"></i> Nuestra sucursal</h2>
        ...
        ?>
                    ...
                    <div class="card rounded-25">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-subtitle">
                                ...
                                ?>
                                <span class="badge rounded-pill bg-danger">Cerrado</span>
                                <?php }else{ ?>
                            ...
                            ?>
                            <p class="card-text my-2">Horarios de apertura:
                                <?php echo $open[0].":".$open[1]." - ".$close[0].":".$close[1];?></p>
                            <div class="text-end">
                                <a href="<?php echo "shop_menu.php?s_id=".$row["s_id"]?>"
                                    class="btn btn-sm btn btn-primary">Ir a la tienda</a>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="row row-cols-1 w-100">
                <div class="col mt-4 pt-3 px-3 bg-danger text-white rounded text-center">
                    ...
                    <p class="ms-2 mt-2">No hay ninguna tienda disponible actualmente para realizar pedidos.</p>
                </div>
            </div>
            <?php
        }
        ...
        <div class="container py-md-3 text-center">
            <div class="last-lavi-inner-content px-lg-5 ">
                <h3 class="mb-4 tittle-wthree">Empezar con <span>Pedido </span> en línea !</h3>
                <p class="px-lg-5">Estás a sólo unos pasos de acercarte a nosotros.. <br>Si aún no te has registrado, ¿qué estás esperando? Simplemente regístrate y pide de nuestros productos en línea.<br></p>
                <div class="buttons mt-md-4 mt-3">


                    <?php if(!isset($_SESSION['cid'])){ ?>
                <a class="btn btn-primary me-2" href="cust_regist.php">Registrar</a>
                <a class="btn btn-success" href="cust_login.php">Iniciar Sesión</a>
                <?php }else{ ?>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <!-- </li>
                    <li class="nav-item"> -->
                        <a class="mx-2 mt-1 mt-md-0 btn btn-outline-danger" href="logout.php">Cerrar Sesión</a>
                    </li>
                </ul>
                <?php } ?>
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        ...
        <h2>Envianos un mensaje</h2>
            <p class="lead fw-normal"><i>"No hay mejor triángulo amoroso que una rebanada de Pizza."</i></p>
            <center>
  <a class="btn btn-primary me-1" href="contact.php"
     style="background-color: #ff6600; border-color: #ff6600; color: #ffffff;">
    Contáctanos
  </a>
</center>
