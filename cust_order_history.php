...
<head>
    ...
    <title>Historial de Pedidos | Pizzas Roca Jed</title>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="shop-body">
        ...
        <div class="mb-3 text-wrap" id="shop-header">
            <h2 class="display-6 strong fw-normal">Historial de Pedidos</h2>
        </div>
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active px-4" id="ongoing-tab" data-bs-toggle="tab" data-bs-target="#nav-ongoing"
                    ...
                    aria-selected="true">&nbsp;En curso&nbsp;</button>
                <button class="nav-link px-4" id="completed-tab" data-bs-toggle="tab" data-bs-target="#nav-completed"
                    type="button" role="tab" aria-controls="nav-completed" aria-selected="false">Completado</button>
            </div>
        </nav>
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active p-3" id="nav-ongoing" role="tabpanel" aria-labelledby="ongoing-tab">
                <?php
                $ongoing_query = "SELECT * FROM order_header WHERE c_id = {$_SESSION['cid']} AND orh_orderstatus <> 'FNSH' ORDER BY orh_id DESC;";
            ...
            ?>
                        ...
                        <a href="cust_order_detail.php?orh_id=<?php echo $og_row["orh_id"]?>"
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                        <div class="col pt-2 border-top"><?php echo $ord_arr["cnt"]?> Articulo(s)</div>
                ...
                <div class="row row-cols-1">
                    <div class="col pt-3 px-3 bg-danger text-white rounded text-center">
                        ...
                        <p class="ms-2 mt-2">Aún no tienes ningún pedido.</p>
                    </div>
                </div>
                <!-- END CASE NO ORDERS -->
                <?php } ?>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="card-text row row-cols-1 small">
                                        ...
                                        $ord_arr = $mysqli -> query($ord_query) -> fetch_array();
                                    ?>
                                        <div class="col pt-2 border-top"><?php echo $ord_arr["cnt"]?> Artículo(s)</div>
                                        <div class="col mt-1 mb-2"><strong class="h5"><?php echo $ord_arr["gt"]?>
                                                $.</strong></div>
                                        <div class="col text-end">
                                            <a href="cust_order_detail.php?orh_id=<?php echo $og_row["orh_id"]?>"
