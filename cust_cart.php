...
<head>
    ...
    <title>Mi Carrito | Pizzas Roca Jed</title>
</head>
...
<body class="d-flex flex-column h-100">
        ...
        <div class="row my-4">
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">Artículo actualizado exitosamente!</span>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    ...
                    </svg><span class="ms-2 mt-2">No se pudo actualizar su artículo.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="cust_cart.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">Se elimino exitosamente tu artículo!</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="cust_cart.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <path
                            d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                    </svg><span class="ms-2 mt-2">No se pudo eliminar tu artículo.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="cust_cart.php">X</a></span>
                </div>
            </div>
        ...
        <div class="row row-cols-1 row-cols-md-2 mb-5">
            <div class="col">
                <div class="row row-cols-1">
                    <div class="col">
                        <h5 class="fw-light">Mi pedido</h5>
                        <p class="fw-light">de
                            <?php
                    ...
                    <div class="col">
                            ...
                            <li
                                ...
                                <div class="ms-3 mt-3 me-auto">
                                    <div class="fw-normal"><span class="h5"><?php echo $row["ct_amount"]?>x</span>
                                        <?php echo $row["f_name"]?>
                                        <p><?php printf("$. %.2f  <small class='text-muted'>( $. %.2f  each)</small>",$row["f_price"]*$row["ct_amount"],$row["f_price"])?><br />
                                            ...
                                            <ul class="list-unstyled list-inline">
                                                ...
                                                <?php
                                                    ...
                                                    if($disable_shop || ($disable_preorder && !$shop_opening)){
                                                        ...
                                                        <span class="badge rounded-pill bg-danger">Hoy no disponible</span>
                                                        <?php
                                                            if($disable_preorder){$rmv = true;}
                                                        }
                                                        else if($row["f_preorderavail"]==0){?>
                                                        <span class="badge rounded-pill bg-danger">Reserva no disponible</span>
                                                        <?php
                                        ...
                                        <a href="remove_cart_item.php?rmv=1&s_id=<?php echo $cart_result["s_id"];?>&f_id=<?php echo $row["f_id"];?>"
                                            class="text-decoration-none text-danger nav nav-item small">Remover el artículo</a>
                                        <?php }else {?>
                                        <a href="cust_update_cart.php?s_id=<?php echo $cart_result["s_id"];?>&f_id=<?php echo $row["f_id"];?>"
                                            class="text-decoration-none text-success nav nav-item small">Editar articulo</a>
                                        <?php } ?>
                                    </div>
                            </li>
                            <!-- END CART ITEM -->
                        ...
                        <div class="col my-3">
                            <ul class="list-inline justify-content-between">
                                ...
                                <li class="list-inline-item fw-light me-5">Gran total</li>
                ...
                <div class="row row-cols-1">
                    <div class="col mb-3">
                        <div class="card p-2 p-md-4 border-0 border-bottom">
                            <h5 class="card-title fw-light">Mi información</h5>
                            <ul class="card-text list-unstyled m-0 p-0 small">
                                ...
                                ?>
                                <li>Nombre: <?php echo $_SESSION["firstname"]." ".$_SESSION["lastname"]; ?></li>
                    ...
                    <form method="POST" action="add_order.php">
                        <div class="col mb-1">
                            <div class="card px-2 px-md-4 pb-1 pb-md-2 border-0">
                                <h5 class="card-title fw-light">Detalle de recogida</h5>
                                <label for="pickuptime" class="form-label small">Fecha y hora de recogida</label>
                                ...
                                >
                                <input type="hidden" name="payamount" value="<?=$order_cost?>">
                                <div id="passwordHelpBlock" class="form-text smaller-font pt-2">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        ?>
                                        <li class="list-item text-danger fw-bold">Esta tienda no acepta ningún pedido.</li>
                                        <?php }else{
                                                if($disable_today){
                                                //Case 2: Shop close today but accept pre-order
                                            ?>
                                        <li class="list-item text-danger fw-bold">Esta tienda no acepta pedidos para hoy..</li>
                                        <li class="list-item">Pero, puedes recoger el pedido mañana desde<?php echo $shop_timerange;?></li>
                                        <?php } else if($disable_preorder){
                                                //Case 3: Shop open today but NOT accepting pre-order
                                        ?>
                                        <li class="list-item">Puedes realizar pedidos en esta tienda hasta<?php echo $shop_close?></li>
                                        <li class="list-item text-danger fw-bold">Pero esta tienda no acepta ningún pedido anticipado..</li>
                                        <?php } else {
                                        ...
                                        ?>
                                        <li class="list-item">Puedes realizar pedidos en esta tienda hasta <?php echo $shop_close?></li>
                                        <li class="list-item">Además, puedes recoger tu pedido mañana desde <?php echo $shop_timerange;?></li>
                                        <?php       }else if($now_time<$shop_open){
                                                    //Case 4.2: Shop window is not open yet ?>
                                        <li class="list-item">Esta tienda abrirá hoy desde <?php echo $shop_timerange;?>.</li>
                                        <li class="list-item">También puedes recoger tu pedido mañana desde <?php echo $shop_timerange;?></li>
                                        <?php       }else{ //Case 4.2: Shop window is already close for today ?>
                                        <li class="list-item text-danger fw-bold">Esta tienda ya está cerrada por hoy.</li>
                                        <li class="list-item">Pero puedes recoger el pedido mañana desde <?php echo $shop_timerange;?></li>
                                        <?php }
                                                }
                                            }
                                ...
                                <div class="form-group">
                                    <input type="text" name='ref' class="form-control" id="ref" aria-describedby="ref" placeholder="Referecia" required>
                                    <small id="refHelp" class="form-text text-muted">Introduzca una Referecia</small>
                                </div>
                                <br>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary left">Confirmar pedido</button>
                                </div>
                            </div>
                        </div>
                        </form>
    ...
    <button type="submit" class="w-100 btn btn-danger disabled" name="place_order" id="place_order" disabled>
        <?php
            if(!$min_cost){
                echo "Su pedido es inferior al importe mínimo.";
            }else{
                echo "No se puede proceder con el pago";
            }
        ?>
    </button>
<?php }else{ ?>
...
<?php
// Asegúrate de que $order_id esté definido y tenga un valor.
if (isset($_SESSION['orh_id'])) {
    // Asegúrate de que $order_detail[0]['orh_id'] esté definido.
    $order_id = $order_detail[0]['orh_id']; // Esto debe tener un valor válido.
    ?>
        <h4 class="mb-2">Método de pedido:</h4>
    <a href="order_success.php?orh=<?php echo $order_id; ?>" 
       class="omise-checkout-button" style="color: #fff !important;">
       <i class="fas fa-cart-arrow-down"></i> Confirmar pedido
    </a>
<?php } else { 
    // Aquí también debes asegurarte de que $order_id tenga un valor.
    ?>
    <!--a href="order_success.php?id=25&orh=25" 
       class="omise-checkout-button" style="color: #ffffff !important; background-color: #ff8c00; border: 1px solid #ff8c00; padding: 10px 20px; text-align: center; display: inline-block; border-radius: 5px; text-decoration: none; font-size: 16px;">
       <i class="fas fa-cart-arrow-down"></i> Confirmar pedido
    </!--a-->
<?php } ?>

    <!-- Eliminamos el script de Omise -->
<?php } ?>
  ...
  <div class="text-center p-2 p-2 mb-1 bg-dark text-white">
    <p class="text-white">Copyright © 2022 Pizzas Roca Jed. Todos los derechos reservados.  </p>
