...
<head>
    ...
    <title>Error al Registrarse | Pizzas Roca Jed</title>
</head>
...
<header class="navbar navbar-expand-md navbar-light fixed-top shadow-sm mb-auto" style="background-color: #ff8c00;">
    ...
    <div class="container form-signin text-center reg-fail mt-auto">
            ...
            <h3 class="mt-2 mb-3 fw-normal text-bold">No se puede registrar</h3>
            <p class="mb-3 fw-normal text-bold">Lo sentimos, nos hemos encontrado con el error.<br/>
                <code>
                    <?php
                        $error_code = $_GET["err"];
                        if ($error_code == 1062){
                            echo "Hay una cuenta con el mismo nombre de usuario o correo electrónico";
                        }else{
            ...
            <a class="btn btn-danger btn-sm w-50" href="index.php">Volver a inicio</a>
    </div>
