...
<head>
    ...
    <title>Shop Menu | Pizzas Roca Jed</title>
</head>
    ...
    <div class="container px-5 py-4" id="shop-body">
                ...
                if($_GET["atc"]==1){
                    ...
                    <div class="row row-cols-1 notibar pb-3">
                        <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                            ...
                            <span class="ms-2 mt-2">Producto añadido a tu carrito con éxito!</span>
            ...
            <?php }else{ ?>
                    ...
                    <div class="row row-cols-1 notibar">
                        <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                            ...
                            </svg><span class="ms-2 mt-2">No se pudo agregar el producto a su carrito.</span>
                            <span class="me-2 float-end"><a class="text-decoration-none link-light" href="shop_menu.php?s_id=<?php echo $s_id;?>">X</a></span>
                        </div>
                    </div>
        ...
        <div class="mb-3 text-wrap" id="shop-header">
            ...
            <ul class="list-unstyled">
                ...
                <li class="">Número de teléfono: <?php echo "(+52) ".$shop_row["s_phoneno"];?></li>
            </ul>
        </div>

        <!-- GRID MENUS SELECTION -->
        <h3 class="border-top py-3 mt-2">Menú</h3>
