...
<head>
    ...
    <title>Alimento | Pizzas Roca Jed</title>
</head>
                ...
                <div class="form-amount">
                    <form class="mt-3" method="POST" action="cust_update_cart.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="addrequest" class="d-inline-text">Información Adicional (Opcional)</label>
